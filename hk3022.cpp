...
//  128 - Признак полной записи (выводятся все поля в виде полного значения)
// Далее в соответствии с установленными битами флагов событий выводятся параметры:
// 2. Фактическое давление. Тип int16_t, выводится разница с предыдущим значением в потоке.
// 3. Режим работы и подача мощности. Тип int8_t, выводится значение (0 - отключено слежение, 1 - включено слежение до запуска насоса, 2 - слежение после запуска насоса, 3 - сухой ход) += 4 если включен насос.
