...
//    8 - (Резерв) Режим работы (0 - отключено слежение, 1 - включено слежение, 2 - сухой ход)
...
// 4. Режим работы. Тип int8_t, выводится значение (0 - отключено слежение, 1 - включено слежение, 2 - сухой ход).
