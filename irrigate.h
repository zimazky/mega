...
public:  
  ...
  uint8_t Mduration = 5;     // Продолжительность полива в минутах (от 1 до 255 минут)
  ...
  program start = program(255,255);  // Время начала запуска в десятиминутках (0-143, 255 - выключен) (48- 8ч)
  program duration = program(2,2);// Продолжительность полива в минутах (от 1 до 255 минут)
